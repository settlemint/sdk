...
export type RegistryType = z.infer<typeof registryItemSchema>["type"];
...
// from https://github.com/shadcn-ui/ui/blob/main/packages/shadcn/src/utils/registry/schema.ts
