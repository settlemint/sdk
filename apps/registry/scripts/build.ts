...
const registries = [
  {
    ...
    registryDependencies: [
      ...
      "https://settlemint.github.io/sdk/tab-navigation.json",
    ],
    tailwind: {},
    cssVars: {},
    meta: {},
  ...
  },
  {
    ...
    files: [
      {
        type: "registry:ui",
        path: new Glob("./components/ui/tab-navigation/**/*"),
        targetFunction: (path: string) => path.replace("components/ui/tab-navigation", "components/ui/tab-navigation"),
      },
    ],
    dependencies: [],
    registryDependencies: ["navigation-menu", "badge"],
    tailwind: {},
    cssVars: {},
    meta: {},
    docs: "",
