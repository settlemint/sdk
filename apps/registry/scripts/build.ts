...
const registries = [
  {
    ...
    registryDependencies: [
      ...
      "https://console-release.settlemint.com/registry/form.json",
      "https://console-release.settlemint.com/registry/input-numeric.json",
  ...
  },
  {
    ...
    dependencies: ["react-dropzone", "uuid", "@hookform/resolvers", "usehooks-ts", "sonner"],
    devDependencies: ["@types/uuid"],
    registryDependencies: ["textarea", "button", "input"],
    tailwind: {},
    cssVars: {},
    meta: {},
    docs: "",
