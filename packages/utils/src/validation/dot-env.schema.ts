...
import { UrlOrPathSchema, UrlSchema } from "./url.schema.js";
/**
...
export const DotEnvSchema = z.object({
  ...
  SETTLEMINT_HASURA_ENDPOINT: UrlOrPathSchema.optional(),
  SETTLEMINT_HASURA_ADMIN_SECRET: z.string().optional(),
  SETTLEMINT_THEGRAPH: IdSchema.optional(),
  SETTLEMINT_THEGRAPH_SUBGRAPH_ENDPOINT: UrlOrPathSchema.optional(),
  SETTLEMINT_THEGRAPH_SUBGRAPH_ENDPOINT_FALLBACK: UrlOrPathSchema.optional(),
  SETTLEMINT_PORTAL: IdSchema.optional(),
  SETTLEMINT_PORTAL_GRAPHQL_ENDPOINT: UrlOrPathSchema.optional(),
