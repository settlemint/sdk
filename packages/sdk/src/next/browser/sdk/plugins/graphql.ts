 ...
 * It uses the NEXT_PUBLIC_SETTLEMINT_APP_URL environment variable to construct the GraphQL endpoint URL.
 *
 ...
 * @throws {Error} If the NEXT_PUBLIC_SETTLEMINT_APP_URL environment variable is not defined.
 *
 * @example
 * ```typescript
