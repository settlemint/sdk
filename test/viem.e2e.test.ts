...
import { getChainId, getPublicClient, getWalletClient, WalletVerificationType } from "@settlemint/sdk-viem";
...
describe("Viem E2E Tests", () => {
  ...
  test(
    "can execute custom json rpc methods",
    async () => {
      const env = await loadEnv(false, false);
