    ...
    task: async () => {
      await writeEnv(
        prod,
        {
          ...
          SETTLEMINT_HASURA_DATABASE_USERNAME: env.SETTLEMINT_HASURA_DATABASE_USERNAME,
          SETTLEMINT_HASURA_DATABASE_DB_NAME: env.SETTLEMINT_HASURA_DATABASE_DB_NAME,
          SETTLEMINT_SMART_CONTRACT_ADDRESS: env.SETTLEMINT_SMART_CONTRACT_ADDRESS,
          SETTLEMINT_SMART_CONTRACT_DEPLOYMENT_ID: env.SETTLEMINT_SMART_CONTRACT_DEPLOYMENT_ID,
        },
        false,
      );
      ...
      await writeEnv(
        prod,
        {
          ...
          SETTLEMINT_HASURA_DATABASE_PASSWORD: env.SETTLEMINT_HASURA_DATABASE_PASSWORD,
        },
        true,
      );
    },
