...
export const DotEnvSchema = z.object({
  ...
  SETTLEMINT_HASURA_DATABASE_USERNAME: z.string().optional(),
  SETTLEMINT_HASURA_DATABASE_PASSWORD: z.string().optional(),
  SETTLEMINT_HASURA_DATABASE_DB_NAME: z.string().optional(),
