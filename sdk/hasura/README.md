...
Defined in: [sdk/hasura/src/hasura.ts:119](https://github.com/settlemint/sdk/blob/v1.2.0/sdk/hasura/src/hasura.ts#L119)
...
| ------ | ------ | ------ |
| `client` | `GraphQLClient` | [sdk/hasura/src/hasura.ts:123](https://github.com/settlemint/sdk/blob/v1.2.0/sdk/hasura/src/hasura.ts#L123) |
| `graphql` | `initGraphQLTada`\<`Setup`\> | [sdk/hasura/src/hasura.ts:124](https://github.com/settlemint/sdk/blob/v1.2.0/sdk/hasura/src/hasura.ts#L124) |
...
Defined in: [sdk/hasura/src/postgres.ts:83](https://github.com/settlemint/sdk/blob/v1.2.0/sdk/hasura/src/postgres.ts#L83)
...
Defined in: [sdk/hasura/src/hasura.ts:35](https://github.com/settlemint/sdk/blob/v1.2.0/sdk/hasura/src/hasura.ts#L35)
...
Defined in: [sdk/hasura/src/hasura.ts:10](https://github.com/settlemint/sdk/blob/v1.2.0/sdk/hasura/src/hasura.ts#L10)
...
Defined in: [sdk/hasura/src/hasura.ts:18](https://github.com/settlemint/sdk/blob/v1.2.0/sdk/hasura/src/hasura.ts#L18)
