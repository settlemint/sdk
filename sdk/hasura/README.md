...
Defined in: [sdk/hasura/src/hasura.ts:111](https://github.com/settlemint/sdk/blob/v1.0.8/sdk/hasura/src/hasura.ts#L111)
...
| ------ | ------ | ------ |
| `client` | `GraphQLClient` | [sdk/hasura/src/hasura.ts:115](https://github.com/settlemint/sdk/blob/v1.0.8/sdk/hasura/src/hasura.ts#L115) |
| `graphql` | `initGraphQLTada`\<`Setup`\> | [sdk/hasura/src/hasura.ts:116](https://github.com/settlemint/sdk/blob/v1.0.8/sdk/hasura/src/hasura.ts#L116) |
...
Defined in: [sdk/hasura/src/postgres.ts:83](https://github.com/settlemint/sdk/blob/v1.0.8/sdk/hasura/src/postgres.ts#L83)
...
Defined in: [sdk/hasura/src/hasura.ts:33](https://github.com/settlemint/sdk/blob/v1.0.8/sdk/hasura/src/hasura.ts#L33)
...
Defined in: [sdk/hasura/src/hasura.ts:10](https://github.com/settlemint/sdk/blob/v1.0.8/sdk/hasura/src/hasura.ts#L10)
...
Defined in: [sdk/hasura/src/hasura.ts:18](https://github.com/settlemint/sdk/blob/v1.0.8/sdk/hasura/src/hasura.ts#L18)
