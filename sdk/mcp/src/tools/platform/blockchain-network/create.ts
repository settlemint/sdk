...
export const platformBlockchainNetworkCreate = (server: McpServer, env: Partial<DotEnv>, pat: string) => {
  ...
  server.tool(
    ...
    async ({
      applicationUniqueName: providedAppName,
      name,
      type,
      size,
      provider,
      ...
      const applicationUniqueName = env.SETTLEMINT_APPLICATION || providedAppName;
        ...
        content: [
          {
            ...
            description: `Created blockchain network: ${name} in application: ${applicationUniqueName}`,
