...
Defined in: [settlemint.ts:237](https://github.com/settlemint/sdk/blob/v2.1.5/sdk/js/src/settlemint.ts#L237)
...
Defined in: [settlemint.ts:125](https://github.com/settlemint/sdk/blob/v2.1.5/sdk/js/src/settlemint.ts#L125)
...
Defined in: [settlemint.ts:117](https://github.com/settlemint/sdk/blob/v2.1.5/sdk/js/src/settlemint.ts#L117)
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="accesstoken"></a> `accessToken` | `string` | `AccessTokenSchema` | The access token used to authenticate with the SettleMint platform | `ClientOptions.accessToken` | [helpers/client-options.schema.ts:9](https://github.com/settlemint/sdk/blob/v2.1.5/sdk/js/src/helpers/client-options.schema.ts#L9) |
| <a id="anonymous"></a> `anonymous?` | `boolean` | `undefined` | Whether to allow anonymous access (no access token required) | - | [settlemint.ts:119](https://github.com/settlemint/sdk/blob/v2.1.5/sdk/js/src/settlemint.ts#L119) |
| <a id="instance"></a> `instance` | `string` | `UrlSchema` | The URL of the SettleMint instance to connect to | `ClientOptions.instance` | [helpers/client-options.schema.ts:11](https://github.com/settlemint/sdk/blob/v2.1.5/sdk/js/src/helpers/client-options.schema.ts#L11) |
...
Defined in: [graphql/application.ts:24](https://github.com/settlemint/sdk/blob/v2.1.5/sdk/js/src/graphql/application.ts#L24)
...
Defined in: [graphql/blockchain-network.ts:82](https://github.com/settlemint/sdk/blob/v2.1.5/sdk/js/src/graphql/blockchain-network.ts#L82)
...
Defined in: [graphql/blockchain-node.ts:96](https://github.com/settlemint/sdk/blob/v2.1.5/sdk/js/src/graphql/blockchain-node.ts#L96)
...
Defined in: [graphql/custom-deployment.ts:33](https://github.com/settlemint/sdk/blob/v2.1.5/sdk/js/src/graphql/custom-deployment.ts#L33)
...
Defined in: [graphql/insights.ts:37](https://github.com/settlemint/sdk/blob/v2.1.5/sdk/js/src/graphql/insights.ts#L37)
...
Defined in: [graphql/integration-tool.ts:35](https://github.com/settlemint/sdk/blob/v2.1.5/sdk/js/src/graphql/integration-tool.ts#L35)
...
Defined in: [graphql/load-balancer.ts:31](https://github.com/settlemint/sdk/blob/v2.1.5/sdk/js/src/graphql/load-balancer.ts#L31)
...
Defined in: [graphql/middleware.ts:43](https://github.com/settlemint/sdk/blob/v2.1.5/sdk/js/src/graphql/middleware.ts#L43)
...
Defined in: [graphql/middleware.ts:101](https://github.com/settlemint/sdk/blob/v2.1.5/sdk/js/src/graphql/middleware.ts#L101)
...
Defined in: [graphql/platform.ts:51](https://github.com/settlemint/sdk/blob/v2.1.5/sdk/js/src/graphql/platform.ts#L51)
...
Defined in: [graphql/private-key.ts:27](https://github.com/settlemint/sdk/blob/v2.1.5/sdk/js/src/graphql/private-key.ts#L27)
...
Defined in: [graphql/storage.ts:35](https://github.com/settlemint/sdk/blob/v2.1.5/sdk/js/src/graphql/storage.ts#L35)
...
Defined in: [graphql/workspace.ts:26](https://github.com/settlemint/sdk/blob/v2.1.5/sdk/js/src/graphql/workspace.ts#L26)
