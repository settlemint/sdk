...
Defined in: [settlemint.ts:239](https://github.com/settlemint/sdk/blob/v2.3.5/sdk/js/src/settlemint.ts#L239)
...
Defined in: [settlemint.ts:127](https://github.com/settlemint/sdk/blob/v2.3.5/sdk/js/src/settlemint.ts#L127)
...
Defined in: [settlemint.ts:117](https://github.com/settlemint/sdk/blob/v2.3.5/sdk/js/src/settlemint.ts#L117)
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="accesstoken"></a> `accessToken?` | `string` | `undefined` | The access token used to authenticate with the SettleMint platform | - | [settlemint.ts:119](https://github.com/settlemint/sdk/blob/v2.3.5/sdk/js/src/settlemint.ts#L119) |
| <a id="anonymous"></a> `anonymous?` | `boolean` | `undefined` | Whether to allow anonymous access (no access token required) | - | [settlemint.ts:121](https://github.com/settlemint/sdk/blob/v2.3.5/sdk/js/src/settlemint.ts#L121) |
| <a id="instance"></a> `instance` | `string` | `UrlSchema` | The URL of the SettleMint instance to connect to | `Omit.instance` | [helpers/client-options.schema.ts:11](https://github.com/settlemint/sdk/blob/v2.3.5/sdk/js/src/helpers/client-options.schema.ts#L11) |
...
Defined in: [graphql/application.ts:24](https://github.com/settlemint/sdk/blob/v2.3.5/sdk/js/src/graphql/application.ts#L24)
...
Defined in: [graphql/blockchain-network.ts:82](https://github.com/settlemint/sdk/blob/v2.3.5/sdk/js/src/graphql/blockchain-network.ts#L82)
...
Defined in: [graphql/blockchain-node.ts:96](https://github.com/settlemint/sdk/blob/v2.3.5/sdk/js/src/graphql/blockchain-node.ts#L96)
...
Defined in: [graphql/custom-deployment.ts:33](https://github.com/settlemint/sdk/blob/v2.3.5/sdk/js/src/graphql/custom-deployment.ts#L33)
...
Defined in: [graphql/insights.ts:37](https://github.com/settlemint/sdk/blob/v2.3.5/sdk/js/src/graphql/insights.ts#L37)
...
Defined in: [graphql/integration-tool.ts:35](https://github.com/settlemint/sdk/blob/v2.3.5/sdk/js/src/graphql/integration-tool.ts#L35)
...
Defined in: [graphql/load-balancer.ts:31](https://github.com/settlemint/sdk/blob/v2.3.5/sdk/js/src/graphql/load-balancer.ts#L31)
...
Defined in: [graphql/middleware.ts:43](https://github.com/settlemint/sdk/blob/v2.3.5/sdk/js/src/graphql/middleware.ts#L43)
...
Defined in: [graphql/middleware.ts:101](https://github.com/settlemint/sdk/blob/v2.3.5/sdk/js/src/graphql/middleware.ts#L101)
...
Defined in: [graphql/platform.ts:56](https://github.com/settlemint/sdk/blob/v2.3.5/sdk/js/src/graphql/platform.ts#L56)
...
Defined in: [graphql/private-key.ts:44](https://github.com/settlemint/sdk/blob/v2.3.5/sdk/js/src/graphql/private-key.ts#L44)
...
Defined in: [graphql/storage.ts:35](https://github.com/settlemint/sdk/blob/v2.3.5/sdk/js/src/graphql/storage.ts#L35)
...
Defined in: [graphql/workspace.ts:26](https://github.com/settlemint/sdk/blob/v2.3.5/sdk/js/src/graphql/workspace.ts#L26)
