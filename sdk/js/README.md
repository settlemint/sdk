...
Defined in: [settlemint.ts:216](https://github.com/settlemint/sdk/blob/v1.2.1/sdk/js/src/settlemint.ts#L216)
...
Defined in: [settlemint.ts:111](https://github.com/settlemint/sdk/blob/v1.2.1/sdk/js/src/settlemint.ts#L111)
...
Defined in: [settlemint.ts:103](https://github.com/settlemint/sdk/blob/v1.2.1/sdk/js/src/settlemint.ts#L103)
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="accesstoken"></a> `accessToken` | `string` | `AccessTokenSchema` | The access token used to authenticate with the SettleMint platform | `ClientOptions.accessToken` | [helpers/client-options.schema.ts:9](https://github.com/settlemint/sdk/blob/v1.2.1/sdk/js/src/helpers/client-options.schema.ts#L9) |
| <a id="anonymous"></a> `anonymous?` | `boolean` | `undefined` | Whether to allow anonymous access (no access token required) | - | [settlemint.ts:105](https://github.com/settlemint/sdk/blob/v1.2.1/sdk/js/src/settlemint.ts#L105) |
| <a id="instance"></a> `instance` | `string` | `UrlSchema` | The URL of the SettleMint instance to connect to | `ClientOptions.instance` | [helpers/client-options.schema.ts:11](https://github.com/settlemint/sdk/blob/v1.2.1/sdk/js/src/helpers/client-options.schema.ts#L11) |
...
Defined in: [graphql/application.ts:24](https://github.com/settlemint/sdk/blob/v1.2.1/sdk/js/src/graphql/application.ts#L24)
...
Defined in: [graphql/blockchain-network.ts:32](https://github.com/settlemint/sdk/blob/v1.2.1/sdk/js/src/graphql/blockchain-network.ts#L32)
...
Defined in: [graphql/blockchain-node.ts:51](https://github.com/settlemint/sdk/blob/v1.2.1/sdk/js/src/graphql/blockchain-node.ts#L51)
...
Defined in: [graphql/custom-deployment.ts:33](https://github.com/settlemint/sdk/blob/v1.2.1/sdk/js/src/graphql/custom-deployment.ts#L33)
...
Defined in: [graphql/insights.ts:37](https://github.com/settlemint/sdk/blob/v1.2.1/sdk/js/src/graphql/insights.ts#L37)
...
Defined in: [graphql/integration-tool.ts:35](https://github.com/settlemint/sdk/blob/v1.2.1/sdk/js/src/graphql/integration-tool.ts#L35)
...
Defined in: [graphql/middleware.ts:43](https://github.com/settlemint/sdk/blob/v1.2.1/sdk/js/src/graphql/middleware.ts#L43)
...
Defined in: [graphql/middleware.ts:101](https://github.com/settlemint/sdk/blob/v1.2.1/sdk/js/src/graphql/middleware.ts#L101)
...
Defined in: [graphql/platform.ts:51](https://github.com/settlemint/sdk/blob/v1.2.1/sdk/js/src/graphql/platform.ts#L51)
...
Defined in: [graphql/private-key.ts:27](https://github.com/settlemint/sdk/blob/v1.2.1/sdk/js/src/graphql/private-key.ts#L27)
...
Defined in: [graphql/storage.ts:35](https://github.com/settlemint/sdk/blob/v1.2.1/sdk/js/src/graphql/storage.ts#L35)
...
Defined in: [graphql/workspace.ts:26](https://github.com/settlemint/sdk/blob/v1.2.1/sdk/js/src/graphql/workspace.ts#L26)
