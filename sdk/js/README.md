...
Defined in: [sdk/js/src/settlemint.ts:275](https://github.com/settlemint/sdk/blob/v2.6.4/sdk/js/src/settlemint.ts#L275)
...
Defined in: [sdk/js/src/settlemint.ts:145](https://github.com/settlemint/sdk/blob/v2.6.4/sdk/js/src/settlemint.ts#L145)
...
Defined in: [sdk/js/src/settlemint.ts:135](https://github.com/settlemint/sdk/blob/v2.6.4/sdk/js/src/settlemint.ts#L135)
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="accesstoken"></a> `accessToken?` | `string` | `undefined` | The access token used to authenticate with the SettleMint platform | - | [sdk/js/src/settlemint.ts:137](https://github.com/settlemint/sdk/blob/v2.6.4/sdk/js/src/settlemint.ts#L137) |
| <a id="anonymous"></a> `anonymous?` | `boolean` | `undefined` | Whether to allow anonymous access (no access token required) | - | [sdk/js/src/settlemint.ts:139](https://github.com/settlemint/sdk/blob/v2.6.4/sdk/js/src/settlemint.ts#L139) |
| <a id="instance"></a> `instance` | `string` | `UrlSchema` | The URL of the SettleMint instance to connect to | `Omit.instance` | [sdk/js/src/helpers/client-options.schema.ts:11](https://github.com/settlemint/sdk/blob/v2.6.4/sdk/js/src/helpers/client-options.schema.ts#L11) |
...
Defined in: [sdk/js/src/graphql/application.ts:24](https://github.com/settlemint/sdk/blob/v2.6.4/sdk/js/src/graphql/application.ts#L24)
...
Defined in: [sdk/js/src/graphql/blockchain-network.ts:55](https://github.com/settlemint/sdk/blob/v2.6.4/sdk/js/src/graphql/blockchain-network.ts#L55)
...
Defined in: [sdk/js/src/graphql/blockchain-node.ts:69](https://github.com/settlemint/sdk/blob/v2.6.4/sdk/js/src/graphql/blockchain-node.ts#L69)
...
Defined in: [sdk/js/src/graphql/custom-deployment.ts:33](https://github.com/settlemint/sdk/blob/v2.6.4/sdk/js/src/graphql/custom-deployment.ts#L33)
...
Defined in: [sdk/js/src/graphql/insights.ts:37](https://github.com/settlemint/sdk/blob/v2.6.4/sdk/js/src/graphql/insights.ts#L37)
...
Defined in: [sdk/js/src/graphql/integration-tool.ts:35](https://github.com/settlemint/sdk/blob/v2.6.4/sdk/js/src/graphql/integration-tool.ts#L35)
...
Defined in: [sdk/js/src/graphql/load-balancer.ts:31](https://github.com/settlemint/sdk/blob/v2.6.4/sdk/js/src/graphql/load-balancer.ts#L31)
...
Defined in: [sdk/js/src/graphql/middleware.ts:56](https://github.com/settlemint/sdk/blob/v2.6.4/sdk/js/src/graphql/middleware.ts#L56)
...
Defined in: [sdk/js/src/graphql/middleware.ts:115](https://github.com/settlemint/sdk/blob/v2.6.4/sdk/js/src/graphql/middleware.ts#L115)
...
Defined in: [sdk/js/src/graphql/platform.ts:56](https://github.com/settlemint/sdk/blob/v2.6.4/sdk/js/src/graphql/platform.ts#L56)
...
Defined in: [sdk/js/src/graphql/private-key.ts:44](https://github.com/settlemint/sdk/blob/v2.6.4/sdk/js/src/graphql/private-key.ts#L44)
...
Defined in: [sdk/js/src/graphql/storage.ts:35](https://github.com/settlemint/sdk/blob/v2.6.4/sdk/js/src/graphql/storage.ts#L35)
...
Defined in: [sdk/js/src/graphql/workspace.ts:26](https://github.com/settlemint/sdk/blob/v2.6.4/sdk/js/src/graphql/workspace.ts#L26)
