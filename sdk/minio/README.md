...
Defined in: [sdk/minio/src/minio.ts:24](https://github.com/settlemint/sdk/blob/v1.1.14/sdk/minio/src/minio.ts#L24)
...
| ------ | ------ | ------ |
| `client` | `Client` | [sdk/minio/src/minio.ts:24](https://github.com/settlemint/sdk/blob/v1.1.14/sdk/minio/src/minio.ts#L24) |
