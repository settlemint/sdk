...
Defined in: [sdk/blockscout/src/blockscout.ts:75](https://github.com/settlemint/sdk/blob/v2.2.3/sdk/blockscout/src/blockscout.ts#L75)
...
| ------ | ------ | ------ |
| `client` | `GraphQLClient` | [sdk/blockscout/src/blockscout.ts:79](https://github.com/settlemint/sdk/blob/v2.2.3/sdk/blockscout/src/blockscout.ts#L79) |
| `graphql` | `initGraphQLTada`\<`Setup`\> | [sdk/blockscout/src/blockscout.ts:80](https://github.com/settlemint/sdk/blob/v2.2.3/sdk/blockscout/src/blockscout.ts#L80) |
...
Defined in: [sdk/blockscout/src/blockscout.ts:23](https://github.com/settlemint/sdk/blob/v2.2.3/sdk/blockscout/src/blockscout.ts#L23)
...
| ------ | ------ | ------ | ------ |
| <a id="accesstoken"></a> `accessToken` | `string` | `ApplicationAccessTokenSchema` | [sdk/blockscout/src/blockscout.ts:17](https://github.com/settlemint/sdk/blob/v2.2.3/sdk/blockscout/src/blockscout.ts#L17) |
| <a id="instance"></a> `instance` | `string` | `UrlOrPathSchema` | [sdk/blockscout/src/blockscout.ts:16](https://github.com/settlemint/sdk/blob/v2.2.3/sdk/blockscout/src/blockscout.ts#L16) |
...
Defined in: [sdk/blockscout/src/blockscout.ts:10](https://github.com/settlemint/sdk/blob/v2.2.3/sdk/blockscout/src/blockscout.ts#L10)
...
Defined in: [sdk/blockscout/src/blockscout.ts:15](https://github.com/settlemint/sdk/blob/v2.2.3/sdk/blockscout/src/blockscout.ts#L15)
